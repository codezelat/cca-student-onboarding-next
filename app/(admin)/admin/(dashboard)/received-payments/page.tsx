            ...
            <div className="mb-8 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    ...
                    <p className="text-gray-600">
                        Review and manually verify student payment slips submitted via the update portal.
                    </p>
                </div>
                ...
                <div className="flex items-center gap-3">
                    <div className="px-5 py-3 bg-white/60 backdrop-blur-md border border-white/50 shadow-sm rounded-xl flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-xs font-bold text-gray-500 uppercase tracking-wider">Pending Slips</p>
                            <p className="text-xl font-black text-gray-800">{pendingPayments.length}</p>
                        </div>
                    </div>
                </div>
            </div>
