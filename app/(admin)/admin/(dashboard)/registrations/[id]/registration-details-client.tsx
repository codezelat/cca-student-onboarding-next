...
export default function RegistrationDetailsClient({
    ...
    const documents = [
        ...(registration.passportPhoto
            ? [
                  {
                      url: registration.passportPhoto,
    ...
    async function handlePaymentSubmit(formData: FormData) {
        ...
        try {
            ...
            window.location.reload(); // Revalidate data
        } catch (error) {
            toast({
                title: "Error",
                        ...
                        <DataGrid
                            items={[
                                ...
                                },
                                {
                                    label: "Home Contact",
                                    value:
                                        registration.homeContactNumber || "N/A",
                                },
                                {
                                    label: "Address",
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <p className="font-semibold text-gray-900 mt-1 capitalize">
                                        {registration.highestQualification.replace(
                                            /_/g,
                                            " ",
                                        )}
                                    </p>
