              ...
              <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <h1 className="text-5xl lg:text-7xl font-bold leading-tight">
                    ...
                    <br />
                    <span className="text-gray-800">Your Career</span>
                  </h1>
                  <p className="text-xl lg:text-2xl text-gray-600 leading-relaxed">
                    Transform your future with industry-leading programs
                    designed to fast-track your professional growth.
                  </p>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  >
                    ...
                    <div className="relative">
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        Curated curriculum designed with industry experts to
                  ...
                  >
                    ...
                    <div className="relative">
                      ...
                      <p className="text-gray-700 leading-relaxed">
                        Earn certifications valued by employers across the
                        industry.
                      </p>
                    </div>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  >
                    ...
                    <div className="flex-1 text-left">
                      <p className="font-semibold">Start Registration</p>
